...
class BaseKeypoint(object):
    ...
    def find_best_result(self, im_source: image_type, im_search: image_type, threshold: Union[int, float] = None, rgb: bool = None): ...
    ...
    def extract_good_points(self, im_source: Image, im_search: Image, kp_src: keypoint_type, kp_sch: keypoint_type, good: good_match_type) -> Optional[Rect]: ...

    def _cal_confidence(self, im_source: Image, im_search: Image, crop_rect: Rect, rgb: bool) -> Union[int, float]: ...
