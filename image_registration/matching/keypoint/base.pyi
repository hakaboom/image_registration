...
class BaseKeypoint(object):
    ...
    def find_all_result(self, im_source: image_type, im_search: image_type, threshold: Union[int, float] = None, rgb: bool = None, max_count: int = 10, max_iter_counts: int = 20): ...
